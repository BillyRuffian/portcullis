...
describe ParliamentWrittenQuestions::Configuration do
  let(:config) { ParliamentWrittenQuestions::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("http://localhost")
    # ParliamentWrittenQuestions.configure do |c|
    #   c.host = uri.host
