...
# Unit tests for ParliamentWrittenQuestions::ProblemDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ParliamentWrittenQuestions::ProblemDetails do
  let(:instance) { ParliamentWrittenQuestions::ProblemDetails.new }

  describe 'test an instance of ProblemDetails' do
    it 'should create an instance of ProblemDetails' do
      expect(instance).to be_instance_of(ParliamentWrittenQuestions::ProblemDetails)
    end
  end
